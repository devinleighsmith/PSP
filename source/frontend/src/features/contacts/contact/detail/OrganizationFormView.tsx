  ...
  return (
    <>
      <Section className="mb-4">
        ...
        <SectionField
          data-testid="contact-organization-organizationName"
          label="Organization Name"
          labelWidth="3"
        >
          <FaRegBuilding size={20} className="mr-2" /> <b>{organization.name}</b>
        </SectionField>
        <SectionField
          data-testid="contact-organization-incorporationNumber"
          label="Alias"
          labelWidth="3"
        >
          {organization.alias}
        ...
        <SectionField
          data-testid="contact-organization-alias"
