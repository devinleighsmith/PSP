...
export const mockLookups: Partial<ILookupCode>[] = [
  ...
  { id: '1', name: 'CA', isDisabled: false, displayOrder: 1, type: 'PimsCountry', rowVersion: 1 },
  { id: '2', name: 'US', isDisabled: false, displayOrder: 2, type: 'PimsCountry', rowVersion: 1 },
  { id: '3', name: 'MX', isDisabled: false, displayOrder: 3, type: 'PimsCountry', rowVersion: 1 },
  {
    id: '4',
    name: 'OTHER',
    isDisabled: false,
