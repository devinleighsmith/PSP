...
{
    /// <summary>
    /// PurposeConfiguration class, provides a way to configure purposes in the database.
    ///</summary>
    public class PurposeConfiguration : LookupEntityConfiguration<Purpose, int>
    {
        #region Methods
